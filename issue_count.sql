...
union all
(select 'LOW' as priority,'POLYGONS WITH SAME IDS AND TYPES' as Issue, (select count(*) from public.geocheck_duplicate_polygon_point_localid) as count, 'geocheck_duplicate_polygon_point_localid' as View )
union all
